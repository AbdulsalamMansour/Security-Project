...
class Encryption {
    ...
    public Encryption(String plainKey, String path) {
    ...
    private void wrapper(){
        ...
        try {
            ...
            byte [] bytesExtension = getExtension(path).getBytes();
            ...
            for (int i = 0; i < bytesExtension.length ; i++) {
                ...
                stamp[outerCounter] = bytesExtension[i];
                outerCounter++;
            }
    ...
    public String recoverKey(String superKey){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public void manhattanCipherEncrypt (){
    ...
    public void manhattanCipherDecrypt (){
    ...
    public void caeserCipherEncrypt (){
    ...
    public void caeserCipherDecrypt (){
    ...
    public static int[][] generateVigenere() {
        ...
        ArrayList<ArrayList> vigenereList = new ArrayList<ArrayList>();

        for (int i = 0; i < 256; i++) {

            vigenereList.add(new ArrayList<Integer>(inner));
    ...
    public static void rotateList(ArrayList<Integer> list) {
    ...
    public void vectorOfPermutationEncrypt () {
    ...
    public void vectorOfPermutationDecrypt () {
    ...
    private void vectorOfPermutationBlockDecrypt (int [] [] vp , int [] keyValues , int [] cipher ){
        ...
        for (int i = keyValues.length - 2; i >=0 ; i--) {
            ...
            for (int j = 0; j <keyValues.length ; j++) {
                ...
                vp [innerCount] [j] = vp [innerCount-1] [j];
